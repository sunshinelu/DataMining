package com.evayInfo.Inglory.akka.demo.spark2
...
trait DatabaseAccess {
  ...
  val config = ConfigFactory.load("/Users/sunlu/Documents/workspace/IDEA/DataMining/src/main/scala/com/evayInfo/Inglory/akka/demo/spark2/application.conf")
