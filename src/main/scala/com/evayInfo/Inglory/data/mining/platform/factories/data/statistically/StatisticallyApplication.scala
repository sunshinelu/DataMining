package com.evayInfo.Inglory.data.mining.platform.factories.data.statistically

/**
 * Created by sunlu on 18/11/29.
 */
class StatisticallyApplication {

  def statistically(algorithm:String,algorithm_option:String,algorithm_mode:String,
