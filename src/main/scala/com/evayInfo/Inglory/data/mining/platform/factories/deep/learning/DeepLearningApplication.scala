package com.evayInfo.Inglory.data.mining.platform.factories.deep.learning
...
class DeepLearningApplication {
  ...
  def deepLearning(algorithm:String,algorithm_option:String,algorithm_mode:String,
