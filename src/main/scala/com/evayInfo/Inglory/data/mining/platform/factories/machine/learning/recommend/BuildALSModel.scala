...
class BuildALSModel {
  ...
  def ALSModel(train_table:String,user_col:String,item_col:String,rating_col:String,rank:Int,numIterations:Int,lambda:Double,model_path:String)={
    ...
    val SparkConf = new SparkConf().setAppName(s"BuildALSModel:ALSModel").setMaster(spark_master).set("spark.executor.memory", spark_executor_memory)
...
//    val lambda = 0.01
  ...
  */
  def ALSModel_test(train_table:String,user_col:String,item_col:String,rating_col:String,
    ...
    val SparkConf = new SparkConf().setAppName(s"BuildALSModel:ALSModel_test").setMaster(spark_master).set("spark.executor.memory", spark_executor_memory)
    val spark = SparkSession.builder().config(SparkConf).getOrCreate()
    val sc = spark.sparkContext
    import spark.implicits._
  ...
  */
  def ALSModelImplicit(train_table:String,user_col:String,item_col:String,rating_col:String,
    ...
    val SparkConf = new SparkConf().setAppName(s"BuildALSModel:ALSModelImplicit").setMaster(spark_master).set("spark.executor.memory", spark_executor_memory)
    val spark = SparkSession.builder().config(SparkConf).getOrCreate()
    val sc = spark.sparkContext
    import spark.implicits._
...
//    val alpha = 0.01
  ...
  */
  def ALSModelImplicit_Test(train_table:String,user_col:String,item_col:String,rating_col:String,
    ...
    val SparkConf = new SparkConf().setAppName(s"BuildALSModel:ALSModelImplicit_Test").setMaster(spark_master).set("spark.executor.memory", spark_executor_memory)
    val spark = SparkSession.builder().config(SparkConf).getOrCreate()
    val sc = spark.sparkContext
    import spark.implicits._
